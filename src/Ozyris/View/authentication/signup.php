...
<div class="col-md-6 col-md-offset-2 cadre-form">
    ...
    <form action="/authentication/signup" method="post" role="form" id="register-form" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="confirm" class="col-sm-4 control-label">Confirmation :</label>
            <div class="col-sm-4">
                <input type="password" required="required" name="confirm" placeholder="********" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-4"></div>
            <div class="col-sm-4">
                <div class="g-recaptcha" data-sitekey="<?= isset($this->siteKey) ? $this->siteKey : ''; ?>"></div>
            </div>
        </div>
        <div class="form-group">
